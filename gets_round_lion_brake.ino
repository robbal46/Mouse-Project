...
void setMotorSpeeds(){
  ...
  if(now>8500 && now<=8650 || now>4250 && now<4350){
    brakeMotor();
    brake = true; 
    
  }
  else if(now > 6600 && now <= 8500){
  ...
  else if (inductorFValue <= 350 && distanceError < 0 && ((now > 4100 && now < 5500) || now>8500)){
    sensorPID.SetOutputLimits((-1*boostSpeed), boostSpeed);
